# Análise de políticas públicas de agricultura familiar

### Para analisarmos os dados vamos propor as seguintes perguntas para o debate

- Onde encontrar esses dados?
- Que perguntas responderemos com eles?
- Que algoritmos e métodos estatísticos iremos implementar?
- Que orientações e caminhos eles nos darão?

Confira abaixo algumas das políticas públicas existentes:

- **PRONAF** – Programa Nacional de Fortalecimento da Agricultura Familiar
- **PAA** – Programa de Aquisição de Alimentos
- **PNAE** – Programa Nacional de Alimentação Escolar
- **PROGRAMA FOMENTO RURAL** – Programa de Fomento às Atividades Produtivas Rurais

*Temos ainda o CAF, cadastro nacional da agricultura familiar.*

---

### Por hora, vamos analisar o pronaf...

  O PRONAF (Programa Nacional de Fortalecimento da Agricultura Familiar) é uma das principais políticas públicas do Governo Federal brasileiro, destinada a financiar atividades e serviços agropecuários e não agropecuários realizados por agricultores familiares.
